...
<link rel="stylesheet" href="${ctx}/js/plugins/font-awesome/css/font-awesome.min.css">

<script type="text/javascript" src="${ctx}/js/jquery.min.js"></script>
<script type="text/javascript" src="${ctx}/js/plugins/layui/layui.js"></script>

<script type="text/javascript" src="${ctx}/js/plugins/layer/2.4/layer.js"></script>


<!-- jtree -->
<link rel="stylesheet" href="${ctx}/js/plugins/jstree/dist/themes/default/style.min.css" />
<script src="${ctx}/js/plugins/jstree/dist/jstree.min.js"></script>

<!-- icon -->
<link rel="stylesheet" type="text/css" href="${ctx}/js/plugins/h-ui/lib/Hui-iconfont/1.0.8/iconfont.css" />
