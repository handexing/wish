...
function BpmnRenderer(eventBus, styles, pathMap, canvas, priority) {
  ...
  function createMarker(type, fill, stroke) {
    ...
    if (type === 'sequenceflow-end') {
      ...
      var sequenceflowEndGreen = svgCreate('path');
      svgAttr(sequenceflowEndGreen, { d: 'M 1 5 L 11 10 L 1 15 Z' });
      addMarker("sequenceflow-end-green", {
          element: sequenceflowEndGreen,
          ref: { x: 11, y: 10 },
          scale: 0.5,
          attrs: {
            fill: "#00b04e",
      ...
      var sequenceflowEndGray = svgCreate('path');
      svgAttr(sequenceflowEndGray, { d: 'M 1 5 L 11 10 L 1 15 Z' });
      addMarker("sequenceflow-end-gray", {
          element: sequenceflowEndGray,
          ref: { x: 11, y: 10 },
          scale: 0.5,
          attrs: {
        	  fill: '#9E9E9E',
